...
class Regx(Appintment):
    ...
    # def CheckAppoint(self,appoint_for = None):
    #     self.connection()
    #     data = (appoint_for)
    #     query ='''select appoint_for from appointment where appoint_for in ('skin','body','ent');'''
    ...
    #     if record == None:
    #         return True
    #     elif record[0] == appoint_for:
    #         return "TreatMent Type Not Exist"
